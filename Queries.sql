...
select 
	case	
		...
		when professional_status = 'civil_servant' then 'funcionário(a) publico(a)'
...
select 
	case 
		when datediff('years', birth_date, '2022-03-18') < 20 then '0-20'
		when datediff('years', birth_date, '2022-03-18') < 40 then '20-40'
		when datediff('years', birth_date, '2022-03-18') < 60 then '40-60'
		when datediff('years', birth_date, '2022-03-18') < 80 then '60-80'
...
select 
	case 
		...
		when income < 20000 then '20000-25000'
